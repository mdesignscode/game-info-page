export default function HeartsAndSparks() {
  return (
    <svg
      viewBox="0 0 54 54"
      fill="currentColor"
    ...
    >
      ...
      <g className="sparks">
        <path className="spark" d="M27 8V0M27 46v8" strokeWidth="2"></path>
        <path
          className="spark"
          d="M41.171 12.828l5.657-5.657M12.829 12.828L7.171 7.172"
          strokeWidth="1.99998"
        ></path>
        <path className="spark" d="M46 27h8M8 27H0" strokeWidth="2"></path>
        <path
          className="spark"
