...
export default function NavbarPrimary({
  ...
  function handleHideSearchField() {
    navRef.current.classList.remove("showSearchField");
    setSearchText("");
  }

  return (
    <div className="navigation_primary" ref={navRef}>
      {hideCloseSearch ? (
        <>
          <NavLink to="/" id="home">
            <Nintendo />
        ...
        <>
          <button className="navigation_primarySearch-input">
            <Search />
            <input
          ...
          >
            <Close setStateToHide={setHideCloseSearch} stateToHide={true} />
          </span>
          <SearchResultsField />
        </>
      )}
...
NavbarPrimary.propTypes = {
  ...
  hideCloseSearch: PropTypes.bool.isRequired,
